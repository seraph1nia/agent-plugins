- [ ] 1. Create the new `mat-pocok` package skeleton under `plugins/mat-pocok/` with a valid `apm.yml` so the marketplace can discover the package.
- [ ] 2. Add the first narrowly scoped mat-pocok dev skill under `plugins/mat-pocok/.apm/skills/` and confirm the package still packs cleanly with one real skill.
