...
- [ ] 1. Create `.claude-plugin/marketplace.json` — the root marketplace catalog that lists the `factory` plugin and allows users to add this repo via `/plugin marketplace add github:seraph1nia/agent-plugins`
